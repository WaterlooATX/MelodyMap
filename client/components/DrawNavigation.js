...
class DrawNavigation extends Component {

  constructor(props) {
    super(props);
    this.state = {
      origin: { lat: +this.props.location.lat, lng: +this.props.location.long },
      destination: { lat: +this.props.selectedShow.venue.lat, lng: +this.props.selectedShow.venue.lng },
      directions: null
    }
  } 
